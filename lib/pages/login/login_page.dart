...
class _LoginPageState extends State<LoginPage> {
  ...
  final userCitizenController = TextEditingController();
  ...
  Future<Null> _loginFaceBook() async {
    ...
    print(result.token);
    print(result.declinedPermissions.toString());
    print(result.grantedPermissions.toString());
  }
    ...
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        if (state is LoginStateSuccessful) {
          if (state.modelUserCitizen != null) {
            if (state.modelUserCitizen.userName != null) {
              GetIt.instance<NavigationDataSource>()
                  .pushNavigation(NamePage.homePage);
            }
          }
        }
      },
