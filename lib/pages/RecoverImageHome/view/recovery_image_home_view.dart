...
class RecoverImageHomePage extends StatefulWidget {
  final contextString;
  final pageController;
  RecoverImageHomePage({Key key, this.contextString, this.pageController}) : super(key: key);
  @override
  _RecoverImageHomePageState createState() => _RecoverImageHomePageState();
}

class _RecoverImageHomePageState extends State<RecoverImageHomePage> {
  ...
  _getCustomBody() {
    return BlocBuilder<RecoverImageHomeBloc, RecoverImageHomeState>(
      builder: (context, state) {
        if (state is RecoverImageHomeStateInitial) {
          return ProgressLoading();
        } 
        else if(state is RecoverImageHomeStateStart)
          {
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      height: MediaQuery.of(context).size.width*0.4 / 0.6625,
                                      child: Stack(
                                        alignment: Alignment.center,
                                        children: <Widget>[
                                          Container(
                                  ...
                                  Text(
                                      AppTranslations.of(widget.contextString).text("RecoverImage").toString(),
                                    style: TextStyle(
                                        fontSize: 16,
                                        color: Theme.of(context).primaryColor,
                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                      AppTranslations.of(widget.contextString).text("EditImage").toString(),
                                    style: TextStyle(
                                        fontSize: 16,
                                        color: Theme.of(context).primaryColor,
                                        fontWeight: FontWeight.bold),
